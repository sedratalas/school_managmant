...
import 'package:school_managment/bloc/classes/classes_bloc.dart';
...
import 'package:school_managment/screen/main_page/table_strategies/student_table_strategy.dart';
import 'package:school_managment/screen/main_page/table_strategies/user_table_strategy.dart';
                    ...
                    child: Align(
                      ...
                      child: BlocConsumer<DataTableBloc, DataTableState>(
                        ...
                        builder: (context, state) {
                          ...
                          final String type = state.currentType;

                          TableDisplayStrategy currentTableStrategy;

                          if (type == "student") {
                            currentTableStrategy = StudentTableStrategy(
                            ...
                            currentTableStrategy = UserTableStrategy();
                          }
                          ...
                          return DataTableSection(
                            ...
                            tableStrategy: currentTableStrategy,
                          );
                        },
                      ),
                    ),
